...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="navbar navbar-expand navbar-light bg-light">
        ...
        <img src="https://img.icons8.com/plasticine/2x/books.png" alt="" height="50" width="50">
    ...
    <div style=" height: 80%; display: flex; align-items: center; grid-column-gap: 50px;">
        ...
        <div class="container" style="margin-left:10px;">
            ...
            <div class="row" >
                <div class="col col-6">
                    <img src="https://image.flaticon.com/icons/png/512/1087/1087815.png" alt="" height="400" width="400">
                </div>
                <div class="col col-6" >
        ...
        <div class="container" style="margin-right:10px;">
            ...
            <div class="row" >
                <div class="col col-6">
                    <img src="https://admin.leucotron.com.br/uploads/site/original/prod-software-call-center-1.png"  alt="" height="400" width="400" style="border-radius:40%;">
                </div>
                <div class="col col-6" >
