    ...
    <div class="navbar navbar-extend navbar-light bg-light">
        ...
        <ul class="navbar-nav " style="flex-direction: row;">
            ...
            <li class="nav-item active mr-2">
                <a class="nav-link" href="/home_find">Find</a>
            </li>
        </ul>
    </div>
...
<div class="container mt-2"  style="height: 85%; display: flex;align-items: center; justify-content: center;">
    <div class="row">
        <div class="col box">
            <form class="text-center border border-light p-5 " action="{{route('home_bookById')}}" method="get">
                @csrf
        ...
        <div class="col box ml-5">
            <form class="text-center border border-light p-5 " action="{{route('home_authorById')}}" method="get">
                @csrf
