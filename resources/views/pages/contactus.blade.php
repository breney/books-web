    ...
    <div class="container">
        <div class="row">
            <div class="col col-md-6">
                <form id=""  style=" max-width: 400px" action="{{route('email')}}" method="get">
                    <h2>Contact us</h2>
            ...
            <div class="col col-md-6">
                <img src="{{asset('images/contact.png')}}" alt="" style="height: 500px;width: 500px;">
            </div>
        </div>
